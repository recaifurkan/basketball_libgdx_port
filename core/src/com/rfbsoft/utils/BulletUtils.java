...
public class BulletUtils {
    ...
    public static btBvhTriangleMeshShape createBvhTriangleMeshShapeWithScale(Array<MeshPart> meshParts) {
    ...
    public static btConvexTriangleMeshShape createBvhTriangleMeshShapeWithoutScale(Array<MeshPart> meshParts) {
        btTriangleIndexVertexArray vertexArray = new btTriangleIndexVertexArray(meshParts);
        btConvexTriangleMeshShape btBvhTriangleMeshShape = new btConvexTriangleMeshShape(vertexArray, false);
        return btBvhTriangleMeshShape;
